...
namespace Dungeoneer.Model.Effect
	{
		[Serializable]
		public class TimedAbilityValueEffect : TimedEffect, IValueEffect, IAbilityEffect
		{
			public TimedAbilityValueEffect(Types.Effect effectType, Types.Ability ability, int value, int duration)
		...
		public TimedAbilityValueEffect(XmlNode xmlNode)
				: base(xmlNode)
			{
				ReadXML(xmlNode);
			}
